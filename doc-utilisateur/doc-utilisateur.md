...
- ![add-road.png](add-road.png) cette outil permet d'ajouter une route
- ![waypoint.png](waypoint.png) permet d'ajouter un point de passage au trajet d'une voiture
- ![bus.png](bus.png) permet d'ajouter une ligne de bus

Pour acceder à la légende, cliquez sur ![legende.png](legende.png).
...
- ![speed.png](speed.png) permet de modifier la vitesse d'affichage de la simulation
- ![color-map.png](color-map.png) permet d'activer la visualisation du traffic grâce à un code couleur
- ![day-night.png](day-night.png) permet de choisir entre le mode jour-nuit et le mode classique
